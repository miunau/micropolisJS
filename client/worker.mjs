...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    ...
    css = ["assets/pages/__layout.svelte-7877ad5a.css"];
    styles = {
      "assets/pages/__layout.svelte-7877ad5a.css": __default
    };
  }
});
...
<div id="${"wrapper"}"><main id="${"canvasContainer"}"><div class="${"hidden"}" id="${"opaque"}"></div>
  ...
  <div class="${"hidden modal shadow"}" id="${"nagWindow"}"><header id="${"nagHeader"}" class="${"nagHeader padding10 chunk white alignCenter"}">micropolisJS
    ...
    <div id="${"nagContainer"}" class="${"padding10 open"}"><div id="${"nagMessage"}" class="${"alignCenter"}">-            Whoa! You&#39;ve been playing this thing for half an hour?!? Why not give a few bucks to <a href="${"https://transequality.org/ways-to-give"}" target="${"_blank"}">a good cause</a> to show your appreciation.
      </div>
...
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/3.js"() {
    init_index_svelte();
    entry3 = "pages/index.svelte-47a17427.js";
    js3 = ["pages/index.svelte-47a17427.js", "chunks/index-b6926417.js"];
    css3 = [];
  }
});
...
var manifest = {
  ...
  _: {
    entry: { "file": "start-6651d528.js", "js": ["start-6651d528.js", "chunks/index-b6926417.js"], "css": [] },
    nodes: [
